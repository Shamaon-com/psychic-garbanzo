...
export default function agendaControl(props){

    const dateA = new Date(2020, 3, 16)
    const dateB = new Date(2020, 11, 28)
    const events = {
        "Mon Dec 28 2020": [{
    ...
    const initDate = () => {
        ...
        caluculateDates(month, year);

    };

    const caluculateDates = (month, year) => {
    ...
    const renderEvents = (day) => {
      ...
      if(events[currentDay] !== undefined){
        return (
            <>
            {events[currentDay].map((event, key) => {
                return (
    ...
    return (
        <AdminLayout>
            ...
            <div class="antialiased sans-serif bg-gray-100 w-full">
                    <div class="container mx-auto px-4">
                        ...
                        <div class="bg-white rounded-lg shadow overflow-hidden">
                            ...
                            <div class="flex items-center justify-between py-2 px-6">
                                ...
                                <div class="border rounded-lg px-1 pt-2" >
                                    <button 
                                        type="button"
                                        class="leading-none rounded-lg transition ease-in-out duration-100 inline-flex cursor-pointer hover:bg-gray-200 p-1 items-center"
                                        onClick={(e) => {
                                            if(month > 1) {
                                                setMonth(month - 1); caluculateDates(month - 1, year);
                                            } else {
                                                setMonth(11); setYear(year - 1); caluculateDates(11, year - 1);
                                            }
                                        }}                                        
                                    >
                                    ...
                                    <button 
                                        ...
                                        onClick={(e) => {
                                            if(month < 12) {
                                                ...
                                                setMonth(1); setYear(year + 1); caluculateDates(1, year + 1);
                                            }
                                        }}   
                                    >
                                        <svg class="h-6 w-6 text-gray-500 inline-flex leading-none"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
